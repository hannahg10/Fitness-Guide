Public Class IntermediateCore
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf intSeconds = 25 Then
            lblWorkout.Text = "Plank Jacks"
        ElseIf intSeconds = 35 Then
            lblWorkout.Text = "Plank With Alternating Leg Lifts"
        ElseIf intSeconds = 45 Then
            lblWorkout.Text = "Side Plank with Hip Lifts - Left Side"
        ElseIf intMinutes = 1 And intSeconds = 5 Then
            lblWorkout.Text = "Side Plank with Hip Lifts - Right Side"
        ElseIf intMinutes = 1 And intSeconds = 15 Then
            lblWorkout.Text = "Alternating Opposite Leg Arm Lifts"
        ...
        ElseIf intMinutes = 2 And intSeconds = 15 Then
            lblWorkout.Text = "Plank with Leg Lifts"
    ...
    Private Sub IntermediateCore_Load(sender As Object, e As EventArgs) Handles MyBase.Load
