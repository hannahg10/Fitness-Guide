Public Class AdvancedCore
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf intSeconds = 5 Then
            lblWorkout.Text = "Single Leg V-Ups"
        ...
        ElseIf intSeconds = 35 Then
            lblWorkout.Text = "Bicycle Crunches"
    ...
    Private Sub AdvancedCore_Load(sender As Object, e As EventArgs) Handles MyBase.Load
