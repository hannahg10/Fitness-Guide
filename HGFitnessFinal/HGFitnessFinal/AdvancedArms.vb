Public Class AdvancedArms

    'Declared the variables for the timer as Integer
    Dim intMinutes As Double = 0
    Dim intSeconds As Double = 0
    Dim intMilliseconds As Double = 0
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf intMinutes = 2 And intSeconds = 15 Then
            lblWorkout.Text = "Reverse Plank"
        ElseIf intMinutes = 2 And intSeconds = 35 Then
            lblWorkout.Text = "Seated Arm Stretch - Left"
        ElseIf intMinutes = 2 And intSeconds = 47 Then
            lblWorkout.Text = "Seated Arm Stretch - Right"
    ...
    Private Sub AdvancedArms_Load(sender As Object, e As EventArgs) Handles MyBase.Load
