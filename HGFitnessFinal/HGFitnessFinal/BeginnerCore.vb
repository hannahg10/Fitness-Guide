Public Class BeginnerCore
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf intSeconds = 5 Then
            lblWorkout.Text = "Alternating Standing Bicycle Crunches"
        ElseIf intSeconds = 25 Then
            lblWorkout.Text = "Abdominal Crunches"
        ElseIf intSeconds = 35 Then
            lblWorkout.Text = "Flutter Kicks - Try not to touch the ground with your feet!"
        ElseIf intSeconds = 45 Then
            lblWorkout.Text = "Side Plank with Knee Crunches - Left Side"
        ElseIf intMinutes = 1 And intSeconds = 5 Then
            lblWorkout.Text = "Side Plank with Knee Crunches - Right Side"
        ElseIf intMinutes = 1 And intSeconds = 15 Then
            lblWorkout.Text = "Twisiting Mermaids - Left Side"
        ElseIf intMinutes = 1 And intSeconds = 25 Then
            lblWorkout.Text = "Twisting Mermaids - Right Side"
        ...
        ElseIf intMinutes = 2 And intSeconds = 15 Then
            lblWorkout.Text = "Side Plank with Knee Crunches - Left"
        ElseIf intMinutes = 2 And intSeconds = 25 Then
            lblWorkout.Text = "Side Plank with Knee Crunches - Right"
        ElseIf intMinutes = 2 And intSeconds = 35 Then
            lblWorkout.Text = "Twisting Mermaids - Left"
        ElseIf intMinutes = 2 And intSeconds = 45 Then
            lblWorkout.Text = "Twisting Mermaids - Right"
        ElseIf intMinutes = 2 And intSeconds = 55 Then
            lblWorkout.Text = "Cobra Pose"
    ...
    Private Sub BeginnerCore_Load(sender As Object, e As EventArgs) Handles MyBase.Load
